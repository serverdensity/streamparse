...
def _remove_logs(topology_name, pattern, remove_worker_logs, user, env_user,
                 is_old_storm, remove_all_artifacts, log_path, hosts,
                 pool_size):
    """
...
def remove_logs(topology_name=None, env_name=None, pattern=None,
    ...
    _remove_logs(topology_name, pattern, remove_worker_logs, user,
                 env_dict['user'], is_old_storm, remove_all_artifacts,
                 log_path, env_dict['storm_workers'], pool_size)
...
def main(args):
    ...
    remove_logs(topology_name=args.name, env_name=args.environment,
                ...
                config_file=args.config, pool_size=args.pool_size)
